...
int main() {
    ...
    if (shortestPath != -1) {
        cout << "The shortest possible path from src to dst with at most k stops: " << shortestPath << endl;
    } else {
        cout << "No such route found within the given stops or fuel limit." << endl;
    }
